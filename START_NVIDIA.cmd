...
echo Replacing CPU ONNX Runtime with CUDA 12.x build...
python -m pip uninstall -y onnxruntime >nul 2>nul
python -m pip install "onnxruntime-gpu[cuda,cudnn]==1.26.0" || exit /b 1
...
python -c "import onnxruntime as ort; getattr(ort, 'preload_dlls', lambda **kwargs: None)(); print('ONNX Runtime providers:', ort.get_available_providers())"
echo.
